...
import { BasicToolProperties } from 'src/app/classes/tools-properties/basic-tool-properties';
import { Vec2 } from 'src/app/classes/vec2';
import { BLACK, DEFAULT_MITER_LIMIT, WHITE } from 'src/app/constants/constants';
