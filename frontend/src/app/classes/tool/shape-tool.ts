...
import { DASHED_SEGMENTS, SELECTION_BOX_THICKNESS } from 'src/app/constants/constants';
...
export abstract class ShapeTool extends Tool {
    ...
    override setTypeDrawing(value: string): void {
    ...
    abstract override draw(ctx: CanvasRenderingContext2D): void;

    override setColors(primaryColor: Color, secondaryColor: Color): void {
