...
import { ThicknessSliderComponent } from 'src/app/components/tools-options/thickness-slider/thickness-slider.component';
import { MAXIMUM_THICKNESS, MINIMUM_THICKNESS } from 'src/app/constants/constants';
