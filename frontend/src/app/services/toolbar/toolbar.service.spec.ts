...
import { KeyShortcut } from 'src/app/enums/key-shortcuts.enum';
...
import { BrushService } from 'src/app/services/tools/brush/brush.service';
import { BucketService } from 'src/app/services/tools/bucket/bucket.service';
import { CalligraphyService } from 'src/app/services/tools/calligraphy/calligraphy.service';
import { EllipseService } from 'src/app/services/tools/ellipse/ellipse.service';
import { EraseService } from 'src/app/services/tools/erase/erase.service';
import { EyedropperService } from 'src/app/services/tools/eyedropper/eyedropper.service';
import { GridService } from 'src/app/services/tools/grid/grid.service';
import { LineService } from 'src/app/services/tools/line/line.service';
...
import { TextActionKeysService } from 'src/app/services/tools/text/text-action-keys/text-action-keys.service';
