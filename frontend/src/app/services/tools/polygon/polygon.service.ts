...
import { PolygonProperties } from 'src/app/classes/tools-properties/polygon-properties';
import { Vec2 } from 'src/app/classes/vec2';
import { DASHED_SEGMENTS, MINIMUM_SIDES, SELECTION_BOX_THICKNESS } from 'src/app/constants/constants';
...
export class PolygonService extends ShapeTool {
    ...
    override computeDimensions(): void {
