...
import { BrushProperties } from 'src/app/classes/tools-properties/brush-properties';
import { Vec2 } from 'src/app/classes/vec2';
import { ANGLE_180, DEFAULT_CALLIGRAPHY_LINE_LENGTH, DEFAULT_ROTATION_ANGLE, MAXIMUM_ROTATION_ANGLE } from 'src/app/constants/constants';
...
export class CalligraphyService extends PencilService {
    ...
    protected override drawCursor(): void {
    ...
    override copyTool(tool: CalligraphyService): void {
    ...
    override applyCurrentSettings(): void {
