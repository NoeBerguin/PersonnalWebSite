...
import { ClipboardImage } from 'src/app/classes/clipboard-image';
import { ShapeTool } from 'src/app/classes/tool/shape-tool';
...
import { SelectionAction } from 'src/app/enums/selection-action.enum';
...
import { MagnetismService } from 'src/app/services/tools/selection/magnetism/magnetism.service';
...
export class SelectionService extends ShapeTool {
    ...
    override onMouseScroll(event: WheelEvent): void {
    ...
    override clone(): SelectionService {
