...
import { SprayProperties } from 'src/app/classes/tools-properties/spray-properties';
import { Vec2 } from 'src/app/classes/vec2';
import { SPRAY_INTERVAL } from 'src/app/constants/constants';
