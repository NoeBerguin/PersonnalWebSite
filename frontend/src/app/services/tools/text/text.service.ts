...
import { TextProperties } from 'src/app/classes/tools-properties/text-properties';
import { Vec2 } from 'src/app/classes/vec2';
import { DASHED_SEGMENTS } from 'src/app/constants/constants';
...
export class TextService extends Tool {
    ...
    override copyTool(tool: Tool): void {
        super.copyTool(tool);
